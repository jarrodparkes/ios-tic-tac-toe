...
public class Board {
    ...
    public var emptyCellPositions: [CellPosition] {
    ...
    public func boardAfterMove(position: CellPosition, newValue: CellValue) -> Board {
    ...
    public func setCell(position: CellPosition, value: CellValue) {
    ...
    public func cellArray() -> [Cell] {
        return cells.flatMap { $0 }
    }
    
    public func cellAtPosition(position: CellPosition) -> Cell {
        return cells[position.r][position.c]
    }
    
    public func winner() -> (Bool, CellValue) {
        var win = false
